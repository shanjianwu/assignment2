...
class FullyConnectedNet(object):
  ...
  def __init__(self, hidden_dims, input_dim=3*32*32, num_classes=10,
    ...
    for i in range(self.num_layers):
      self.params['W' + str(i + 1)] = weight_scale * np.random.randn(layer_dims[i],
                                                                     layer_dims[i+1])
  ...
  def loss(self, X, y=None):
    ...
    # layer, etc.                                                              #
    ############################################################################
    h, cache1, bn, cache2, out, cache3, cache4 = {},{},{},{},{},{},{}
    out[0] = X
    for i in range(self.num_layers - 1):
      ...
      if self.use_batchnorm:
        ...
        out[i+1], cache3[i] = relu_forward(out[i], W, b)
        if self.use_dropout:
          out[i+1], cache4[i] = dropout_forward(out[i], self.dropout_param)
      else:
    ...
    for i in range(t):
      if self.use_batchnorm:
        ...
        dbn[t-1-i] = relu_backward(dout[t-1], cache3[t-1-i])
